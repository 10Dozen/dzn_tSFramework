...
<br />2. Частота, позыной ответственного > <font color='#9E9E9E'>(например, КВ 6, JohnDoe)</font>
...
<br />4. Тяжелораненные > <font color='#9E9E9E'>без сознания, например (Lima 2)</font>
...
<br />6. Метод обозначения зоны посадки > <font color='#9E9E9E'>A - панели, B - пиротехнический сигнал, C - дымовой сигнал, D - нет, E - другое (например, Delta)</font>
<br />
