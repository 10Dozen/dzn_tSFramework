...
DEBUG_1("(Renderer.animateAppear) Entity %1 : On State changed: %2", _qe # QE_ID, _qe # QE_STATE);
...
[_qe, STATE_SHOWING, STATE_SHOWN, ANIM_DUR_APPEAR] call self_FUNC(transitToState);
